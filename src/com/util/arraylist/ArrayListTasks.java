...
public class ArrayListTasks {
    ...
    public <T> List<T> getList() throws TaskException{
    	...
    	try{   		
    		String property = System.getProperty("custom.list.class");
    		Class<?> arrayListClass = Class.forName(property);
			...
			List<T> list = (List<T>) constructor.newInstance();
	        return list;
	    	}
	    	catch(Exception e) {
	    		throw new TaskException("Failed to create instance", e);
	    	}
	    }
